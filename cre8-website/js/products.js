...
const PRODUCTS = [
  ...
  },
  {
    ...
    icon:'pistol', images:['/images/products/training-glock19-1.jpg','/images/products/training-glock19-2.jpg'], materials:['PLA Matte'], colors:['Blue','Red','Yellow'], featured:true
  },
  {
